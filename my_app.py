...
countries = [
 ...
 'United States of America' 'Netherlands' 'Germany' 'France' 'Spain'
 'South Africa' 'Italy' 'Canada' 'Switzerland' 'Brazil' 'Australia'
 'Norway' 'Turkey' 'Sweden' 'India' 'Poland' 'Finland' 'Portugal'
 'Austria' 'Belgium' 'Romania' 'Denmark' 'Russian Federation' 'Israel'
 'Ukraine' 'Czech Republic' 'Mexico' 'New Zealand'
]

Dev_type = [
    'Developer, full-stack' 'Developer, back-end' 'Developer, QA or test'
 'Developer, front-end' 'other' 'Developer, mobile'
 'Developer, embedded applications or devices'
 'Developer, desktop or enterprise applications' 'Developer Experience'
 'Developer, game or graphics' 'Developer Advocate'
]

Education = [
    "Bachelor's degree" 'Non-academic degree' "Master's degree"
...
Industry = [
 ...
 'Retail and Consumer Services' 'Higher Education' 'Legal Services'
 'Insurance' 'Healthcare' 'Oil & Gas' 'Wholesale' 'Advertising Services'
]
